...
ALTER TABLE ONLY "public"."ModelPhoto"
    ADD CONSTRAINT "ModelPhoto_ModelID_fkey"
    FOREIGN KEY ("ModelID")
    REFERENCES "public"."AssetModel"("ModelID")
    ON UPDATE CASCADE
    ON DELETE CASCADE;

CREATE INDEX IF NOT EXISTS "idx_model_photo_model_id"
    ON "public"."ModelPhoto" ("ModelID");

CREATE INDEX IF NOT EXISTS "idx_model_photo_sort_order"
    ON "public"."ModelPhoto" ("ModelID", "SortOrder");
