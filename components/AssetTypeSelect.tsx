    ...
    return (
        <div className={`relative ${className}`} ref={wrapperRef}>
            <div
                ...
                className="select-field flex items-center gap-3 cursor-pointer bg-white border border-gray-300 rounded-md px-3 py-2 h-10 shadow-sm"
                style={{ minHeight: '42px' }} // Match standard input height
            >
                {value ? (
                    <>
