...
import { Plus, Box, Layers, Tag, X, GitBranch, MapPin, ExternalLink, CalendarDays, PackagePlus, StickyNote } from "lucide-react";
...
export default function CreateModelDialog({
    ...
    onCreated?: (payload: { category: string; name: string }) => void,
}) {
            ...
            {open && (
                <div className="fixed inset-0 z-50 overflow-y-auto bg-black/40 backdrop-blur-sm transition-opacity">
                    ...
                    <div ref={modalRef} className="bg-white rounded-xl shadow-2xl w-full max-w-[520px] max-h-[calc(100vh-2rem)] overflow-hidden border border-gray-100 flex flex-col">
                        ...
                        <form action={handleSubmit} className="p-6 space-y-8 overflow-y-auto">
                            ...
                            <div className="space-y-5">
                                ...
                                <div className="grid gap-1.5">
                                    ...
                                    <p className="text-xs text-gray-400">This list is loaded from the `AssetType` table so it stays aligned with your inventory setup.</p>
                                </div>
                                ...
                                <div className="grid gap-1.5 pt-2 border-t border-gray-100">
                                    ...
                                    <div className="flex-1">
                                        <p className="text-xs text-gray-500">You can save multiple reference images for this model.</p>
                                        <p className="text-xs text-blue-600 mt-1">
                                            The first image is used as the primary reference in lists and detail pages.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="grid gap-1.5">
                                    ...
                                    />
                                    <p className="text-xs text-gray-400">Best place: right after status, because it belongs to this model's purchase metadata.</p>
                                </div>
                                ...
                                <div className="grid gap-4 rounded-xl border border-emerald-100 bg-emerald-50/60 p-4">
                                    <div>
                                        ...
                                        <p className="text-xs text-gray-500 mt-1">
                                            If you already had this model in the company before using the system, register that opening stock here once.
                                        </p>
                                    </div>
                                    ...
                                    <div className="grid gap-1.5">
                                        ...
                                        />
                                        <p className="text-xs text-gray-400">Example: if you already have 12 keyboards in storage, enter `12` here.</p>
                                    </div>
                                    ...
                                    <div className="grid gap-1.5">
                                        ...
                                        <textarea
                                            ...
                                            rows={2}
                                            placeholder="Already in warehouse before go-live, counted during initial setup..."
