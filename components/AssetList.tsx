...
export default function AssetList({ initialAssets }: { initialAssets: any[] }) {
    ...
    return (
        <div>
            <div className="card" style={{ marginBottom: '1.5rem', padding: '1.5rem', display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
                        ...
                        <tbody>
                            {filteredAssets.map(asset => (
                                <tr key={asset.AssetID}>
                                    ...
                                    <td style={{ fontFamily: 'monospace', fontSize: '0.9em' }}>{asset.SerialNumber}</td>
                                    <td>{asset.DeviceTag || '-'}</td>
                                    <td>
                                        <div style={{ display: 'flex', gap: '0.5rem' }}>
                                            <Link href={`/assets/${asset.AssetID}`} className="btn btn-outline" style={{ padding: '0.25rem 0.6rem', fontSize: '0.8rem' }}>
                                                View/Edit
                                            </Link>
                                            <button
