                    ...
                    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
                        ...
                        <div className="form-group py-2">
                            ...
                            <ModernDatePicker
                                name="requestedDate"
                                required
                                className="h-14 text-lg font-medium border-gray-300 focus:border-blue-500 focus:ring-blue-500 w-full"
                                value={formData.requestedDate}
                                onChange={(e: any) => setFormData({ ...formData, requestedDate: e.target.value })}
                            />
